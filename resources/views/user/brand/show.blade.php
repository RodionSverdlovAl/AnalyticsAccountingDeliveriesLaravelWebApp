...
@section('content')
                    ...
                    <div class="nav-wrapper position-relative end-0">
                        <ul class="nav nav-pills nav-fill p-1 bg-transparent flex-column on-resize" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a href="{{route('user.dashboard')}}" class="nav-link mb-0 px-0 py-1 active " aria-selected="false">
    ...
    <div class="container-fluid py-4">
        <div style="display:flex" class="mb-3">
            <div style="margin-right: 8px"><a  href="{{route('user.brand.show',$brand->id)}}">Все время</a></div>
            <div style="margin-right: 8px"><a  href="{{route('user.brand.show.filterable',[$brand->id, 'year' => '2020'])}}">2020</a></div>
            <div style="margin-right: 8px"><a  href="{{route('user.brand.show.filterable',[$brand->id, 'year' => '2021'])}}">2021</a></div>
            <div style="margin-right: 8px"><a  href="{{route('user.brand.show.filterable',[$brand->id, 'year' => '2022'])}}">2022</a></div>
            <div style="margin-right: 8px"><a  href="{{route('user.brand.show.filterable',[$brand->id, 'year' => '2023'])}}">2023</a></div>
