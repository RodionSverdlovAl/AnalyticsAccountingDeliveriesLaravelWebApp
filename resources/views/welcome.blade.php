...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen  sm:items-center py-4 sm:pt-0">
            ...
            @endif
               <div class="mr-3">
                   <img width="200px" height="200px" src="{{asset('https://mzbn.com/wp-content/uploads/2018/11/logo1.svg')}}" class="mr-3"  alt="main_logo">
                   <h1 class="ml-3">Аналитика брендов</h1><br>
               </div>
