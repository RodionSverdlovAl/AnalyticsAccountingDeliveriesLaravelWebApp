...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html" target="_blank">
            <img src="{{asset('https://mzbn.com/wp-content/uploads/2018/11/logo1.svg')}}" class="navbar-brand-img h-100 mb-2" alt="main_logo"><br>
            <span class="ms-1 font-weight-bold">Портфель брендов</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{route('admin.supplies.index')}}">
                    ...
                    <span class="nav-link-text ms-1">Поставки</span>
                </a>
            </li>
            <li class="nav-item">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <h6 class="font-weight-bolder mb-0">МЗБН бренды</h6>
            </nav>
